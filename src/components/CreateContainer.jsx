    ...
    <div className="w-full min-h-screen flex bg-gray-800 items-center justify-center">
      <div className="w-[90%] md:w-[50%] border bg-white border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-3">
          ...
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
            <FaRupiahSign className="text-gray-700 text-2xl w-5" />
            <input
              type="text"
              required
              value={price}
        ...
        <div className="flex items-center w-full">
          ...
          <button
            type="button"
            className="ml-0 md:ml-auto w-full md:w-auto border-none outline-none bg-emerald-500 hover:bg-emerald-600 px-12 py-2 rounded-lg text-lg text-white font-semibold"
            onClick={saveDetails}
          >
            Save
          </button>
